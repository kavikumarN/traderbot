"""seed portfolio permissions

Revision ID: 08984ea9d2c2
Revises: c4a2e8f91b3d
...
revision: str = "08984ea9d2c2"
down_revision: Union[str, None] = "c4a2e8f91b3d"
...
PERMISSIONS = [
    ("portfolio:read", "View wallet balances, positions, trade history, PnL/ROI/fee summaries, and performance analytics"),
]

# Portfolio has no write surface (it's a read-only aggregation over data
# `TradingService` already writes), so unlike risk/trading every role that
# can see the account at all gets this — including "viewer".
ROLE_GRANTS = {
